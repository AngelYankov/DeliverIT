    ...
    public partial class update : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2021, 4, 25, 12, 30, 19, 653, DateTimeKind.Utc).AddTicks(6144), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2021, 4, 20, 12, 30, 19, 653, DateTimeKind.Utc).AddTicks(5250), false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 1 });

            migrationBuilder.InsertData(
                table: "Shipments",
                columns: new[] { "Id", "Arrival", "CreatedOn", "DeletedOn", "Departure", "IsDeleted", "ModifiedOn", "StatusId", "WarehouseId" },
                values: new object[] { 2, new DateTime(2021, 4, 23, 12, 30, 19, 653, DateTimeKind.Utc).AddTicks(6975), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2021, 4, 19, 12, 30, 19, 653, DateTimeKind.Utc).AddTicks(6941), false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 2 });

            migrationBuilder.InsertData(
                table: "Shipments",
                columns: new[] { "Id", "Arrival", "CreatedOn", "DeletedOn", "Departure", "IsDeleted", "ModifiedOn", "StatusId", "WarehouseId" },
                values: new object[] { 3, new DateTime(2021, 4, 27, 12, 30, 19, 653, DateTimeKind.Utc).AddTicks(6994), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2021, 4, 23, 12, 30, 19, 653, DateTimeKind.Utc).AddTicks(6991), false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 3 });
