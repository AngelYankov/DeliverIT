    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2021, 4, 29, 9, 16, 11, 983, DateTimeKind.Utc).AddTicks(4662), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2021, 4, 24, 9, 16, 11, 983, DateTimeKind.Utc).AddTicks(3495), false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 1 });

            migrationBuilder.InsertData(
                table: "Shipments",
                columns: new[] { "Id", "Arrival", "CreatedOn", "DeletedOn", "Departure", "IsDeleted", "ModifiedOn", "StatusId", "WarehouseId" },
                values: new object[] { 2, new DateTime(2021, 4, 27, 9, 16, 11, 983, DateTimeKind.Utc).AddTicks(5650), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2021, 4, 23, 9, 16, 11, 983, DateTimeKind.Utc).AddTicks(5607), false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 2 });

            migrationBuilder.InsertData(
                table: "Shipments",
                columns: new[] { "Id", "Arrival", "CreatedOn", "DeletedOn", "Departure", "IsDeleted", "ModifiedOn", "StatusId", "WarehouseId" },
                values: new object[] { 3, new DateTime(2021, 5, 1, 9, 16, 11, 983, DateTimeKind.Utc).AddTicks(5667), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2021, 4, 27, 9, 16, 11, 983, DateTimeKind.Utc).AddTicks(5667), false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 3 });
